...
.co-page { padding-top: var(--nav-offset, 68px); min-height: 100svh; }

/* PROGRESS */
.pb-bar { background: #fff; border-bottom: 1px solid #eee; height: 48px; position: sticky; top: var(--nav-offset, 68px); z-index: 90; }
