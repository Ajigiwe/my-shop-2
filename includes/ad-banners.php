...
.ad-slide a, .ad-slide a:visited { text-decoration: none; color: inherit; width: 100%; display: block; position: relative; }
.ad-slide-bgimg { display: block; width: 100%; height: auto; }
.ad-slide-copy { position: absolute; left: 0; bottom: 0; max-width: 56%; padding: 44px; color: #fff; z-index: 2; display: flex; flex-direction: column; align-items: flex-start; }
...
.ad-slide-copy p { font-size: 15px; line-height: 1.6; color: rgba(255,255,255,0.92); margin: 0 0 20px; text-shadow: 0 1px 10px rgba(0,0,0,0.3); }
.ad-slide-btn { display: inline-block; font-family: var(--f-mono); font-size: 11px; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; color: #1f1407; background: #f0c36a; padding: 13px 26px; border-radius: 999px; transition: transform .25s ease, background .25s ease, box-shadow .25s ease; box-shadow: 0 6px 20px rgba(0,0,0,0.25); }
.ad-slide-btn:hover { transform: translateY(-2px); background: #ffd88a; }
.ad-slide .ad-scrim { position: absolute; inset: 0; z-index: 1; background: linear-gradient(90deg, rgba(10,6,2,0.78) 0%, rgba(10,6,2,0.4) 40%, rgba(10,6,2,0.1) 70%, rgba(10,6,2,0) 100%); }
...
@media (max-width: 768px) {
    .ad-slide-copy { max-width: 78%; padding: 28px 22px; }
    .ad-slide .ad-scrim { background: linear-gradient(0deg, rgba(10,6,2,0.85) 0%, rgba(10,6,2,0.4) 55%, rgba(10,6,2,0.1) 100%); }
}
@media (max-width: 480px) {
    .ad-slider { padding: 0 10px; }
    .ad-slide-copy { max-width: 85%; padding: 24px 18px; }
            ...
            <?php foreach ($adBanners as $b): ?>
                ...
                <div class="ad-slide">
                    <a href="<?php echo $link; ?>">
                        <img class="ad-slide-bgimg" src="<?php echo htmlspecialchars($img); ?>" alt="<?php echo htmlspecialchars($b['title'] ?: 'Promotion'); ?>" loading="lazy">
